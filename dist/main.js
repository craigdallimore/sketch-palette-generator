...
(function(exports) {
  ...
  var removeChildren = function (__copy_parentNode) {
      return function __do() {
          ...
          function __tco_loop(parentNode) {
              ...
              throw new Error("Failed pattern match at Util.DOM line 26, column 3 - line 30, column 32: " + [ v.constructor.name ]);
          };
          while (!__tco_done) {
  ...
  //------------------------------------------------------------------------------
  var appendListItem = function (doc) {
          ...
          return function (v) {
              return function __do() {
                  ...
                  var className = (function () {
                      var $20 = Util_Color.isLight(v);
                      if ($20) {
                          return "preview__item preview__item--light";
                      };
                      return "preview__item preview__item--dark";
                  })();
                  var v2 = Data_Functor.map(Control_Monad_Eff.functorEff)(DOM_Node_Types.textToNode)(DOM_Node_Document.createTextNode(hex)(doc))();
                  DOM_Node_Element.setAttribute("style")("background-color:" + (hex + ";"))(v1)();
                  DOM_Node_Element.setClassName(className)(v1)();
                  var v3 = DOM_Node_Node.appendChild(v2)(liNode)();
                  var v4 = DOM_Node_Node.appendChild(liNode)(fragNode)();
                  return fragNode;
              };
          };
      };
  ...
  var createColorListFragNode = function (colors) {
      return function __do() {
          ...
          var v2 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(colors)(appendListItem(v)(v1))();
          return v1;
      };
  };
  ...
  exports["appendListItem"] = appendListItem;
...
(function(exports) {
  ...
  var updateDOM = function (v) {
      return function (input) {
          var fromColors = function (v1) {
              return v1;
          };
          var colors = Data_Array.sort(Util_Types.ordColor)(Data_Array.nub(Util_Types.eqColor)(fromColors(Util_Parse.parse(input))));
          ...
          return function __do() {
              ...
              Util_DOM.updateDownloadLink(v.value2)(sketchPalette)();
              return Data_Unit.unit;
          };
      };
  };
  ...
  var onTextChange = function (v) {
      return function (e) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML_HTMLTextAreaElement.value(v.value0))(updateDOM(v));
      };
  };
  ...
  var main = Control_Bind.bind(Control_Monad_Eff.bindEff)(function __do() {
      var $25 = Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.document)();
      return queryElements(DOM_HTML_Types.htmlDocumentToParentNode($25))();
